...
markup1 = ReplyKeyboardMarkup(resize_keyboard=True).row(
...
markup3 = ReplyKeyboardMarkup(resize_keyboard=True).row(
    button1, button2, button3)

# mind
button1 = KeyboardButton('Да, разобраться с мыслями')  # +
...
markup19 = ReplyKeyboardMarkup(resize_keyboard=True).row(
    button1, button2)

button1 = KeyboardButton('Дальше')  # +
markup01 = ReplyKeyboardMarkup(resize_keyboard=True).row(
    button1)

button1 = KeyboardButton('Слушать')  # +
markup02 = ReplyKeyboardMarkup(resize_keyboard=True).row(
    button1)

button1 = KeyboardButton('Внимать')  # +
markup03 = ReplyKeyboardMarkup(resize_keyboard=True).row(
    button1)

button1 = KeyboardButton('Еще')  # +
markup04 = ReplyKeyboardMarkup(resize_keyboard=True).row(
    button1)

button1 = KeyboardButton('Хорошим')  # +
button2 = KeyboardButton('Плохим')  # +
markup05 = ReplyKeyboardMarkup(resize_keyboard=True).row(
    button1, button2)

button1 = KeyboardButton('Слушать дальше')  # +
markup06 = ReplyKeyboardMarkup(resize_keyboard=True).row(
    button1)

button1 = KeyboardButton('Слушать еще')  # +
markup07 = ReplyKeyboardMarkup(resize_keyboard=True).row(
    button1)

button1 = KeyboardButton('Слушать больше')  # +
markup08 = ReplyKeyboardMarkup(resize_keyboard=True).row(
    button1)
